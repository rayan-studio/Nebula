...
static constexpr UINT WM_OPEN_CODE_MAP = WM_USER + 785;
...
private:
    ...
    std::unique_ptr<CodeMapTabView> codeMapTab_;
...
public:
    ...
    CodeMapTabView *GetCodeMapTabView() { return codeMapTab_.get(); }
