...
namespace Lsp
{
    ...
    private:
        ...
        std::unordered_map<std::wstring, std::unordered_map<std::wstring, Location>> fileSymbolDefLocs_;
        std::unordered_map<std::wstring, std::unordered_map<std::wstring, Location>> fileSymbolDeclLocs_;
